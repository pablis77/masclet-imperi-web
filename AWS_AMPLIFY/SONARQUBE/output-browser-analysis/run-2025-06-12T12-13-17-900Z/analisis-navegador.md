...
|-----------|-------------------------|
| `http://127.0.0.1:8000/api/v1/backup/download/backup_masclet_imperi_20250612_020057.sql?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbmlzdHJhZG9yIiwiZXhwIjoxNzQ5ODE2ODc1fQ.NWtAi0h7UVeqBaMyP1i3nfez5xYO4U40wjNFVmGmQvA` | Reemplazar por variable de entorno `REACT_APP_API_URL` |
| `http://127.0.0.1:8000/api/v1/backup/download/backup_masclet_imperi_20250611_042527.sql?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbmlzdHJhZG9yIiwiZXhwIjoxNzQ5ODE2ODc1fQ.NWtAi0h7UVeqBaMyP1i3nfez5xYO4U40wjNFVmGmQvA` | Reemplazar por variable de entorno `REACT_APP_API_URL` |
| `http://127.0.0.1:8000/api/v1/backup/download/backup_masclet_imperi_20250611_023231.sql?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbmlzdHJhZG9yIiwiZXhwIjoxNzQ5ODE2ODc1fQ.NWtAi0h7UVeqBaMyP1i3nfez5xYO4U40wjNFVmGmQvA` | Reemplazar por variable de entorno `REACT_APP_API_URL` |
| `http://127.0.0.1:8000/api/v1/backup/download/backup_masclet_imperi_20250611_023033.sql?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbmlzdHJhZG9yIiwiZXhwIjoxNzQ5ODE2ODc1fQ.NWtAi0h7UVeqBaMyP1i3nfez5xYO4U40wjNFVmGmQvA` | Reemplazar por variable de entorno `REACT_APP_API_URL` |
| `http://127.0.0.1:8000/api/v1/backup/download/backup_masclet_imperi_20250611_020024.sql?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbmlzdHJhZG9yIiwiZXhwIjoxNzQ5ODE2ODc1fQ.NWtAi0h7UVeqBaMyP1i3nfez5xYO4U40wjNFVmGmQvA` | Reemplazar por variable de entorno `REACT_APP_API_URL` |
| `http://127.0.0.1:8000/api/v1/backup/download/backup_masclet_imperi_20250610_020022.sql?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInJvbGUiOiJhZG1pbmlzdHJhZG9yIiwiZXhwIjoxNzQ5ODE2ODc1fQ.NWtAi0h7UVeqBaMyP1i3nfez5xYO4U40wjNFVmGmQvA` | Reemplazar por variable de entorno `REACT_APP_API_URL` |

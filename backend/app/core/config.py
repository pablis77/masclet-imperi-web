...
class Settings(BaseModel):
    ...
    cors_origins: str = os.getenv("CORS_ORIGINS", "http://localhost:3000,http://localhost:4321,http://127.0.0.1:3000,http://127.0.0.1:4321,https://masclet-imperi-web-frontend.onrender.com")

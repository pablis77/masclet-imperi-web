...
console.log(`>>> Configurando proxy SOLO en /api hacia ${BACKEND_URL}`);
// IMPORTANTE: Solo registramos el proxy en /api para evitar problemas de duplicación
// Esto capturará todas las rutas /api/* incluyendo /api/v1/* sin duplicaciones

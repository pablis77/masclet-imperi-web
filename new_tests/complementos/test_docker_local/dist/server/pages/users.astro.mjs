...
import { a as api } from '../chunks/api_eaCe8RWt.mjs';
import { d as getStoredUser, a as getCurrentLanguage, t, i as isAuthenticated } from '../chunks/Footer_BuyfVHI3.mjs';
import { g as getCurrentRole } from '../chunks/roleService_CkKvQuoA.mjs';
...
const userServiceProxy = {
  ...
  async createUser(userData) {
    try {
      ...
      const response = await api.post("/auth/signup", processedUserData, config);

...
Usa la URL correcta que se ha confirmado funciona en el navegador
"""
...
API_PREFIX = ""  # No hay prefijo /api/v1 como pensábamos
USERNAME = "admin"
PASSWORD = "admin123"
...
def obtener_token():
    """Obtiene token de autenticación usando la URL correcta"""
    color_print(f"=== Obteniendo token para {USERNAME} ===", "blue")
    
    # URL correcta para login según la documentación Swagger
    login_url = f"{BASE_URL}/auth/login"
    
    # Datos para OAuth2 Password Flow
    oauth_data = {
        "username": USERNAME,
        "password": PASSWORD
    }
...
def main():
    ...
    # Probar endpoints de dashboard según la documentación Swagger

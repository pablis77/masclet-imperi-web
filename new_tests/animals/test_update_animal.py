...
if auth_response.status_code == 200:
    ...
    # Datos a actualizar (solo los campos permitidos por el esquema AnimalUpdate)
    update_data = {
        "nom": "Marta",
        "genere": "F",
        "estado": "OK",
    ...
    # Usar PATCH en lugar de PUT para actualizar solo un campo
    update_response = requests.patch(
        f"{BASE_URL}/animals/2736", 
        headers=headers,
        json={"quadra": "Nueva Cuadra"}
    )

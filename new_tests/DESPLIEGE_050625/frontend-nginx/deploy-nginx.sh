...
echo "=== DESPLEGANDO FRONTEND MASCLET IMPERI CON NGINX ==="
...
echo "Construyendo imagen Docker con Nginx..."
docker build -t masclet-frontend:nginx -f ../frontend-nginx.Dockerfile .
...
# Iniciar contenedor
echo "Iniciando contenedor frontend con Nginx..."
...
echo "=== FRONTEND CON NGINX DESPLEGADO EXITOSAMENTE ==="

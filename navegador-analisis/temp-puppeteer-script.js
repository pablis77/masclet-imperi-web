...
const outputDir = './navegador-analisis';
...
(async () => {
    ...
    try {
        ...
        for (const ruta of rutas) {
            const fullUrl = \http://172.20.160.1:3000\;
            console.log(\n📄 Analizando: \);
            ...
            try {
                ...
                // Capturar screenshot
                await page.screenshot({ path: \./navegador-analisis/screenshot-\.png });
        ...
        console.log(✅ Informe Markdown guardado en: \);

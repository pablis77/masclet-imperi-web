...
<script>
  document.addEventListener("DOMContentLoaded", () => {
    console.log("🚀 Página de login cargada - v3 (direct API)");
    ...
    loginForm.addEventListener("submit", async (e) => {
      ...
      try {
        console.log("🔑 Iniciando autenticación directa con " + username);
        ...
        // Llamar directamente al backend utilizando la URL correcta
        const response = await fetch("http://masclet-api:8000/api/v1/auth/login", {
          method: "POST",
          headers: {

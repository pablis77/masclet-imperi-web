...
// Test 2: Verificar que detectSectionFromUrl funciona correctamente
function testDetectSectionFromUrl() {
  ...
  tests.forEach(test => {
    const detected = sectionLoader.detectSectionFromUrl(test.url);
...
const test2Passed = testDetectSectionFromUrl();

...
import 'kleur/colors';
import { $ as $$LoginLayout } from '../chunks/LoginLayout_DzdUaJhE.mjs';
...
}, "C:/Proyectos/claude/masclet-imperi-web/frontend/src/pages/login-deploy.astro", void 0);

const $$file = "C:/Proyectos/claude/masclet-imperi-web/frontend/src/pages/login-deploy.astro";
const $$url = "/login-deploy";
